...
export const API_BASE_URL = process.env.NEXT_PUBLIC_BACKEND_URL || 'https://cementai-backend.onrender.com';
export const WS_URL = process.env.NEXT_PUBLIC_WS_URL || 'wss://cementai-backend.onrender.com';
